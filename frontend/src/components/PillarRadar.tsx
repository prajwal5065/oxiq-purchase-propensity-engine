    ...
    <div className="relative mx-auto" style={{ width: SIZE, height: SIZE }}>
      ...
      <div
        ...
        style={{
          ...
          background:
            "conic-gradient(from 0deg, rgba(0,201,167,0.45) 0deg, rgba(0,201,167,0) 55deg, rgba(0,201,167,0) 360deg)",
        }}
      />
      ...
      <svg width={SIZE} height={SIZE} className="relative">
        ...
        {PILLAR_TYPES.map((_, i) => {
          ...
          return (
            <line key={i} x1={CENTER} y1={CENTER} x2={x} y2={y} stroke="#F1F1EE" strokeWidth={1} />
          );
        })}
        ...
        {PILLAR_TYPES.map((type, i) => {
          ...
          return <circle key={type} cx={x} cy={y} r={3.5} fill="#00C9A7" />;
        })}
      </svg>
