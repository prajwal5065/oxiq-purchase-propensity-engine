    ...
    <div className="relative mx-auto" style={{ width: SIZE, height: SIZE }}>
      ...
      <div
        ...
        style={{
          ...
          background:
            "conic-gradient(from 0deg, rgba(23,231,196,0.55) 0deg, rgba(23,231,196,0) 55deg, rgba(23,231,196,0) 360deg)",
        }}
      />
      ...
      <svg width={SIZE} height={SIZE} className="relative">
        ...
        {PILLAR_TYPES.map((_, i) => {
          ...
          return (
            <line key={i} x1={CENTER} y1={CENTER} x2={x} y2={y} stroke="#202226" strokeWidth={1} />
          );
        })}

        <polygon
          points={scorePoints}
          fill="rgba(23, 231, 196, 0.18)"
          stroke="#17E7C4"
          strokeWidth={2}
        ...
        {PILLAR_TYPES.map((type, i) => {
          ...
          return <circle key={type} cx={x} cy={y} r={3.5} fill="#17E7C4" />;
        })}
      </svg>
